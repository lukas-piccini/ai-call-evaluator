...
export function AudioPlayer() {
  ...
  return (
    <AnimatePresence>
      {currentAudio && (
        <motion.div className="fixed z-100 pointer-events-auto bg-background bottom-0 left-0 right-0 flex items-center justify-between p-4 border-1" key="audio-player" transition={{ y: { bounce: 0 } }} exit={{ y: 300 }} initial={{ y: 300 }} animate={{ y: 0 }}>
